...
\begin{category}{Work experience}
  ...
  \citemnobullet {Actively involved in the design and development of a High performance Trading platforms
                  Was a part of market simplifieds platform team which was responsible for integrating 
                  various brokers into marketsimplifieds single platfrom and protocol. Was actively involved
                  in devoleping an Analitics product which could dirive a score for a stock based on its 
                  technical strength \\}
